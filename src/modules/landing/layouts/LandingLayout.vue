<template>
  <div class="flex flex-col h-screen">
    ...
    <header class="flex items-center h-14 px-4 border-b border-gray-300 sm:h-16 md:px-6 lg:px-8">
      ...
      <nav class="flex flex-col ml-auto space-x-4 items-end h-10 sm:space-x-6 font-semibold">
        <div class="space-x-4">
    ...
    <!-- Main -->
    <main class="flex-1 flex items-center justify-center py-1">
    ...
    <footer class="flex items-center h-14 px-4 border-t border-gray-300 sm:h-16 md:px-6 lg:px-8">
      <p class="flex-1 text-sm text-gray-500 text-center">
        © {{ new Date().getFullYear() }} queenBee Corporation. Rights reserved
      </p>
    </footer>
    <!-- Fin Footer -->
  </div>
